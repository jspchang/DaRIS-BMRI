...
proc createDict_pssd_languages { ns } {
	...
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "mandarin" :variant -lang numeric "14"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "arabic" :variant -lang numeric "15"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "auslan" :variant -lang numeric "16"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "bengali" :variant -lang numeric "17"
	...
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "french" :variant -lang numeric "25"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "hebrew" :variant -lang numeric "26"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "hungarian" :variant -lang numeric "27"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "irish" :variant -lang numeric "28"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "italian" :variant -lang numeric "29"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "japanese" :variant -lang numeric "30"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "korean" :variant -lang numeric "31"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "lebanese" :variant -lang numeric "32"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "macedonian" :variant -lang numeric "33"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "malay" :variant -lang numeric "34"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "maltese" :variant -lang numeric "35"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "nepali" :variant -lang numeric "36"
	dictionary.entry.add  :dictionary ${ns}.pssd.languages :term "portuguese" :variant -lang numeric "37"
