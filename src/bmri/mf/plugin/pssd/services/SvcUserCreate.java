...
public class SvcUserCreate extends PluginService {
	...
	public SvcUserCreate()  {
		...
		_defn.add(ie);
		_defn.add(new Interface.Element("domain", StringType.DEFAULT, "The name of the domain that the users will be created in. Defaults to 'bmri'.", 0, 1));
	...
	public String description() {
		return "Creates a standard Brain and Mind Research Institute  user and assigns their basic PSSD and NIG-PSSD roles.";
	}

	public String name() {
		return "bmri.pssd.user.create";
	}
	...
	public void execute(Element args, Inputs inputs, Outputs outputs, XmlWriter w) throws Throwable {
		...
		dm.add("domain", domain);
		dm.add("user",args.value("user"));
		dm.add("role", "bmri.pssd.model.user");
