...
import bmri.mf.plugin.pssd.BMRIDomainMetaData;
...
public class SvcObjectMetaSet extends PluginService {
	...
	public String name() {
		return "bmri.pssd.object.meta.set";
	}

	public String description() {
		return "Add specific DICOM and/or Bruker subject identifier meta-data elements to PSSD objects (Project,Subject and Study) object via BMRI-PSSD specific Document Types. Only operates on local objects.";
	}
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		if (args.element("dicom") != null || args.element("bruker") != null) {
			...
			BMRIDomainMetaData nmd = new BMRIDomainMetaData();
			if (remove) {
